...
<body>
                        ...
                        @auth
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item" style="margin-right: 10px">
                                    <a href="{{ route('personal.setting.index') }}"
                                        class="btn btn-outline-primary">Профиль</a>
    ...
    <footer class="edica-footer aos-init aos-animate" data-aos="fade-up" style="padding-top: 100px; margin-top: 93px;">
        <div class="container">
